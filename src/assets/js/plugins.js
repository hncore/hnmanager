...
(function($) {
  ...
  function HCFAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  HCFAjaxChosen.prototype.init = function() {
  ...
  HCFAjaxChosen.prototype.events = function() {
  ...
  HCFAjaxChosen.prototype.search_field_focused = function() {
  ...
  HCFAjaxChosen.prototype.search_welcome_message = function() {
  ...
  HCFAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('hcf-chosen', _this.options.data).done( function( response ) {
  ...
  HCFAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.hcf-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.HCFChosenOrder($hidden_value, true);
  ...
  $.fn.HCFAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new HCFAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, HCFAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  HCFAbstractChosenOrder = (function() {

    function HCFAbstractChosenOrder() {}

    HCFAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    HCFAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    HCFAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    HCFAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    HCFAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    HCFAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    HCFAbstractChosenOrder.HCFChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    HCFChosenOrder: function(order, force) {
      return _HCFChosenOrder.HCFChosenOrder(this, order, force);
    }
  });

  this._HCFChosenOrder = (function(_super) {
    __extends(_HCFChosenOrder, _super);

    function _HCFChosenOrder() {
      _ref = _HCFChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _HCFChosenOrder.relAttributeName = 'data-option-array-index';

    _HCFChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _HCFChosenOrder.getDOMElement = function(element) {
    ...
    _HCFChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _HCFChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _HCFChosenOrder;

  })(HCFAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('hcf-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectHCF = FormSerializer.serializeObject;
    $.fn.serializeJSONHCF   = FormSerializer.serializeJSON;
  }
