...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.hcf_gutenberg_blocks ) { return; }

  Object.values(window.hcf_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'hcf-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary hcf-shortcode-button',
              onClick: function () {
                window.hcf_gutenberg_props = props;
              },
            }, block.button_title ),
