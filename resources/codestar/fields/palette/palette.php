 ...
 *
 */
if ( ! class_exists( 'HCF_Field_palette' ) ) {
  class HCF_Field_palette extends HCF_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="hcf-siblings hcf--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' hcf--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="hcf--sibling hcf--palette'. esc_attr( $active ) .'">';
