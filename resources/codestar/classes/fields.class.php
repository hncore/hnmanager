 ...
 *
 */
if ( ! class_exists( 'HCF_Fields' ) ) {
  abstract class HCF_Fields extends HCF_Abstract {
    protected $value;
    protected $unique;
    protected $where;
    protected $parent;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="hcf-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="hcf-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="hcf-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="hcf-help"><span class="hcf-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="hcf-error-text">'. $this->field['_error'] .'</div>' : '';
